...
ThresholdDecide_cpp <- function(hi, hj, n, k, maxSeconds, threads = 1L, bound = 2L, fullDepth = -1L, unitCap = -1L, failStop = -1L) {
    .Call(`_Coreset_ThresholdDecide_cpp`, hi, hj, n, k, maxSeconds, threads, bound, fullDepth, unitCap, failStop)
}

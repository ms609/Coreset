...
DropAddTS_cpp <- function(dmat, m, time_budget_s, max_iter, want_trace) {
    .Call(`_MaxMin_DropAddTS_cpp`, dmat, m, time_budget_s, max_iter, want_trace)
}

DropAddTS_points_cpp <- function(points, m, time_budget_s, max_iter, want_trace) {
    .Call(`_MaxMin_DropAddTS_points_cpp`, points, m, time_budget_s, max_iter, want_trace)
}

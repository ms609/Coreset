...
objective) maximises *separation*. It selects $`m`$ elements such that
...
| Function | Method | Use |
|----|----|----|
| [`KCentre()`](https://ms609.github.io/MaxMin/reference/KCentre.md) | CDSh heuristic (García-Díaz et al. 2017, 2019) | ~1–3.5% of optimum at $`O(N^2 \log N)`$, far tighter than the Gonzalez 2-approximation; never worse than it |
| [`ExactKCentre()`](https://ms609.github.io/MaxMin/reference/ExactKCentre.md) | Min-cover integer program (the covering dual of [`ExactMaxMin()`](https://ms609.github.io/MaxMin/reference/ExactMaxMin.md)) | Proven optimum, small `k` (needs `highs`) |

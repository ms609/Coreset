...
| Function | Method | Use |
|----|----|----|
| [`Gonzalez()`](https://ms609.github.io/MaxMin/reference/Gonzalez.md) | Greedy farthest-first (Gonzalez 1985); default best-of-five ensemble of cheap O(*N*) seeds (centroid, peripheral, 3 reproducible random-furthest starts) | Fast; matrix, coordinate, or distance-column-oracle input (the last for very large sets with no embedding) |

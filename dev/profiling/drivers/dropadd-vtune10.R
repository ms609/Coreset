...
t0 <- proc.time()[[3L]]
for (r in 1:20) o1 <- MaxMin:::DropAdd_cpp(d4, 10L, Inf, 1500L, PL, FALSE, -1L)
for (r in 1:8)  o2 <- MaxMin:::DropAdd_cpp(d4, 2000L, Inf, 1500L, PL, FALSE, -1L)
for (r in 1:4)  o3 <- MaxMin:::DropAdd_points_cpp(big2, 10L, Inf, 1000L, PL, FALSE, -1L)
for (r in 1:3)  o4 <- MaxMin:::DropAdd_points_cpp(big10, 10L, Inf, 600L, PL, FALSE, -1L)
o5 <- MaxMin:::DropAdd_points_cpp(big10, 10000L, Inf, 0L, PL, FALSE, -1L)

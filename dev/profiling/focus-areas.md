...
| 3 | Grasp refinement | `src/grasp.cpp`, `R/grasp.R` | extended-improvement local search scans (n−m) candidates × O(m²) sub-matrix; PR over elite pairs | matrix only | m ∈ {small, large} | 2026-08-13 | OPTIMISED (PR/LS 14–16× T-006; +1.34–2.07× T-007; +2.0–3.8× round 3 T-014; +3.9–4.4× round 4 — LS O(n) nearest-selected screen, header fold, cross-step PR summaries; all bit-identical. Next floor: LS's mandatory m²/2 pair sweep — log.md round 4) |

# Introduction to Coreset

The Coreset package selects a subset that represents a fixed pool of *N*
...
the interior of the set unrepresented. This objective is suited to
defining a representative sample from a fixed pool: picking biological
...
|----|----|----|----|----|
| [`FarFirst()`](https://ms609.github.io/Coreset/dev/reference/FarFirst.md) | max-min / k-centre | Good (2-approximation) | Very fast | No |
| [`DropAdd()`](https://ms609.github.io/Coreset/dev/reference/DropAdd.md) | MMDP (max-min) | High (≈ 99 % optimal) | Fast | No |
| [`Grasp()`](https://ms609.github.io/Coreset/dev/reference/Grasp.md) | MMDP (max-min) | Highest | Moderate | Yes ([`set.seed()`](https://rdrr.io/r/base/Random.html)) |
| [`ExactMaxMin()`](https://ms609.github.io/Coreset/dev/reference/ExactMaxMin.md) | MMDP (max-min) | Optimal (NP-hard) | Slow | No |
| [`ExactMaxSum()`](https://ms609.github.io/Coreset/dev/reference/ExactMaxSum.md) | Max-Sum Diversity | Optimal (NP-hard) | Slow | No |
| [`MaxMean()`](https://ms609.github.io/Coreset/dev/reference/MaxMean.md) | max-mean | High | Time-budgeted | Yes ([`set.seed()`](https://rdrr.io/r/base/Random.html)) |
| [`KCentre()`](https://ms609.github.io/Coreset/dev/reference/KCentre.md) | k-centre | Near-optimal | Fast | No |
| [`ExactKCentre()`](https://ms609.github.io/Coreset/dev/reference/ExactKCentre.md) | k-centre | Optimal (NP-hard) | Slow | No |
| [`MaxEntropy()`](https://ms609.github.io/Coreset/dev/reference/MaxEntropy.md) | maxdet | High / Optimal for small `k` | Fast | No |
...
![](Coreset_files/figure-html/compare-plot-1.png)
...
[`FarFirst()`](https://ms609.github.io/Coreset/dev/reference/FarFirst.md)
is the quickest approximation to the K-centres problem. The CDSh
algorithm implemented in `KCentres()` gives a more sophisticated
heuristic ([García-Díaz et al., 2017](#ref-GarciaDiaz2017); [García-Díaz
et al., 2019](#ref-GarciaDiaz2019)); its solutions are typically within
1–3.5 % of the optimum, compared to ~10% for
[`FarFirst()`](https://ms609.github.io/Coreset/dev/reference/FarFirst.md).
...
|----|----|
| Speed matters most | [`FarFirst()`](https://ms609.github.io/Coreset/dev/reference/FarFirst.md) (ensemble default) |
| Deterministic, good quality valued | [`DropAdd()`](https://ms609.github.io/Coreset/dev/reference/DropAdd.md) |
| Best quality, [`set.seed()`](https://rdrr.io/r/base/Random.html) for reproducibility | [`Grasp()`](https://ms609.github.io/Coreset/dev/reference/Grasp.md) |
...
| Proven optimum, N ≤ ~ 25–30, **highs** installed | [`ExactMaxMin()`](https://ms609.github.io/Coreset/dev/reference/ExactMaxMin.md) |
| Score a selection’s T_(k) | [`MinDist()`](https://ms609.github.io/Coreset/dev/reference/MinDist.md) |
...
| Scenario | Recommended |
|----|----|
| Proven optimum, N ≤ ~ 25–30, **highs** installed | [`ExactMaxSum()`](https://ms609.github.io/Coreset/dev/reference/ExactMaxSum.md) |
...
| Scenario | Recommended |
|----|----|
| Maximize mean pairwise distance, size unfixed | [`MaxMean()`](https://ms609.github.io/Coreset/dev/reference/MaxMean.md) |
| Distances may be negative | [`MaxMean()`](https://ms609.github.io/Coreset/dev/reference/MaxMean.md) |
| Score a selection’s max-mean objective | [`MeanDist()`](https://ms609.github.io/Coreset/dev/reference/MeanDist.md) |

For **covering** (minimise the radius; no point far from a centre):

| Scenario | Recommended |
|----|----|
| Near-optimal covering, fast and deterministic | [`KCentre()`](https://ms609.github.io/Coreset/dev/reference/KCentre.md) (CDSh) |
| Quick 2-approximation baseline | `FarFirst(strategy = "peripheral")` |
| Proven optimum, small N | [`ExactKCentre()`](https://ms609.github.io/Coreset/dev/reference/ExactKCentre.md) |
...
| Scenario | Recommended |
|----|----|
| Maximize spanned volume / avoid near-duplicate selections | [`MaxEntropy()`](https://ms609.github.io/Coreset/dev/reference/MaxEntropy.md) |
...
- **k-means** ([`stats::kmeans()`](https://rdrr.io/r/stats/kmeans.html))
  ...
  relative of
  [`FarFirst()`](https://ms609.github.io/Coreset/dev/reference/FarFirst.md)’s

...
already attach the achieved \\T_k\\ as a `score` attribute. `MinDist()`
allows arbitrary selections to be scored, or an existing selection to be
scored against a different distance matrix.

## See also

[`FarFirst()`](https://ms609.github.io/Coreset/dev/reference/FarFirst.md),
[`DropAdd()`](https://ms609.github.io/Coreset/dev/reference/DropAdd.md),
[`Grasp()`](https://ms609.github.io/Coreset/dev/reference/Grasp.md) and

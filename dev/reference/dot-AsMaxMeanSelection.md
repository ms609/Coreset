# Stamp the `MaxMeanSelection` class onto a [`MaxMean()`](https://ms609.github.io/Coreset/dev/reference/MaxMean.md) result

Parallel to
[`.AsMaxMinSelection()`](https://ms609.github.io/Coreset/dev/reference/dot-AsMaxMinSelection.md)

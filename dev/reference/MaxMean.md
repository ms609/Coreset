...
to score an arbitrary selection under this objective;
...
and [`Grasp()`](https://ms609.github.io/Coreset/dev/reference/Grasp.md)
for fixed-cardinality max-min solvers.

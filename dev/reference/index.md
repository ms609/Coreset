...
- [`KCentre()`](https://ms609.github.io/Coreset/dev/reference/KCentre.md)
  [`KCenter()`](https://ms609.github.io/Coreset/dev/reference/KCentre.md)
  :

  Discrete *k*-centre solver

- [`ExactKCentre()`](https://ms609.github.io/Coreset/dev/reference/ExactKCentre.md)
  [`ExactKCenter()`](https://ms609.github.io/Coreset/dev/reference/ExactKCentre.md)
  :
...
- [`KCentreRadius()`](https://ms609.github.io/Coreset/dev/reference/KCentreRadius.md)
  [`KCenterRadius()`](https://ms609.github.io/Coreset/dev/reference/KCentreRadius.md)
  : Covering radius of a set of centres

## Reporting

- [`format(`*`<MaxMinSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.Coreset.md)
  [`print(`*`<MaxMinSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.Coreset.md)
  : Format and print Coreset solver results
- [`format(`*`<KCentreSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.KCentre.md)
  [`print(`*`<KCentreSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.KCentre.md)
  [`format(`*`<KCentreExact>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.KCentre.md)
  [`print(`*`<KCentreExact>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.KCentre.md)
  : Format and print k-centre solver results
- [`format(`*`<MaxEntropySelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.MaxEntropy.md)
  [`print(`*`<MaxEntropySelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.MaxEntropy.md)
  : Format and print maximum-entropy (maxdet) solver results
- [`format(`*`<MaxMeanSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.MaxMeanSelection.md)
  [`print(`*`<MaxMeanSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.MaxMeanSelection.md)
  [`summary(`*`<MaxMeanSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.MaxMeanSelection.md)
  : Format and print Max-Mean solver results
- [`format(`*`<MaxSumSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.MaxSum.md)
  [`print(`*`<MaxSumSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/print.MaxSum.md)
  : Format and print Max-Sum (maximum diversity) solver results
- [`summary(`*`<MaxMinSelection>`*`)`](https://ms609.github.io/Coreset/dev/reference/summary.Coreset.md)

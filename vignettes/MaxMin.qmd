...
```{r}
#| label: dropadd
res_da <- DropAdd(eurodist, m = 6L, max_no_improve = 500L)
...
infeasible (roughly N > 46 000), use `DropAddPoints()`, which accepts a
...
res_da50 <- DropAdd(d50, m = m, max_no_improve = 500L)

...
```{r}
#| label: MinDist
MinDist(ffPick, d50)                               # from dist
MinDist(ffPick, as.matrix(d50))                    # from square matrix
...
c(KCentre  = KCentreRadius(centres, eurodist),
  FarFirst = KCentreRadius(ff, eurodist))
```

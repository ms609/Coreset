...
|----|----|----|----|----|
| [`FarFirst()`](https://ms609.github.io/Coreset/reference/FarFirst.md) | max-min / k-centre | Good (2-approximation) | Very fast | No |
| [`DropAdd()`](https://ms609.github.io/Coreset/reference/DropAdd.md) | MMDP (max-min) | High (≈ 99 % optimal) | Fast | No |
| [`Grasp()`](https://ms609.github.io/Coreset/reference/Grasp.md) | MMDP (max-min) | Highest | Moderate | Yes ([`set.seed()`](https://rdrr.io/r/base/Random.html)) |
| [`ExactMaxMin()`](https://ms609.github.io/Coreset/reference/ExactMaxMin.md) | MMDP (max-min) | Optimal (NP-hard) | Slow | No |
| [`ExactMaxSum()`](https://ms609.github.io/Coreset/reference/ExactMaxSum.md) | Max-Sum Diversity | Optimal (NP-hard) | Slow | No |
| [`MaxMean()`](https://ms609.github.io/Coreset/reference/MaxMean.md) | max-mean | High | Time-budgeted | Yes ([`set.seed()`](https://rdrr.io/r/base/Random.html)) |
| [`KCentre()`](https://ms609.github.io/Coreset/reference/KCentre.md) | k-centre | Near-optimal | Fast | No |
| [`ExactKCentre()`](https://ms609.github.io/Coreset/reference/ExactKCentre.md) | k-centre | Optimal (NP-hard) | Slow | No |
| [`MaxEntropy()`](https://ms609.github.io/Coreset/reference/MaxEntropy.md) | maxdet | High / Optimal for small `k` | Fast | No |
...
[`FarFirst()`](https://ms609.github.io/Coreset/reference/FarFirst.md) is
...
|----|----|
| Speed matters most | [`FarFirst()`](https://ms609.github.io/Coreset/reference/FarFirst.md) (ensemble default) |
| Deterministic, good quality valued | [`DropAdd()`](https://ms609.github.io/Coreset/reference/DropAdd.md) |
| Best quality, [`set.seed()`](https://rdrr.io/r/base/Random.html) for reproducibility | [`Grasp()`](https://ms609.github.io/Coreset/reference/Grasp.md) |
...
| Proven optimum, N ≤ ~ 25–30, **highs** installed | [`ExactMaxMin()`](https://ms609.github.io/Coreset/reference/ExactMaxMin.md) |
| Score a selection’s T_(k) | [`MinDist()`](https://ms609.github.io/Coreset/reference/MinDist.md) |
...
| Scenario | Recommended |
|----|----|
| Proven optimum, N ≤ ~ 25–30, **highs** installed | [`ExactMaxSum()`](https://ms609.github.io/Coreset/reference/ExactMaxSum.md) |
...
| Scenario | Recommended |
|----|----|
| Maximize mean pairwise distance, size unfixed | [`MaxMean()`](https://ms609.github.io/Coreset/reference/MaxMean.md) |
| Distances may be negative | [`MaxMean()`](https://ms609.github.io/Coreset/reference/MaxMean.md) |
| Score a selection’s max-mean objective | [`MeanDist()`](https://ms609.github.io/Coreset/reference/MeanDist.md) |
...
| Scenario | Recommended |
|----|----|
| Maximize spanned volume / avoid near-duplicate selections | [`MaxEntropy()`](https://ms609.github.io/Coreset/reference/MaxEntropy.md) |
